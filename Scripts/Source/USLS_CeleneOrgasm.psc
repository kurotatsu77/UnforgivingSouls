...
Event OnUpdate() ; This event occurs every five seconds
	...
	ElseIf USLS_Enemalevel.GetValue () < 10
		...
		libs.UnlockDevice(PlayerRef, deviceInventory = loc_suit, zad_DeviousDevice = libs.zad_DeviousSuit, destroydevice = true, genericonly = true)
   		Debug.MessageBox ("Finally the torment is over. You look down at your poor abused swollen body, Your vision still blurred by all the drugs inside you. But at least Celene has gone.")
		Utility.Wait(5)
		...
		Debug.MessageBox ("Until the next time!")
	EndIf
EndEvent
